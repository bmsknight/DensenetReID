# https://github.com/Ning-Ding/Implementation-CVPR2015-CNN-for-ReID/blob/master/market1501/make_hdf5_for_market1501.py
# -*- coding: utf-8 -*-
import os
import h5py
import numpy as np
...
def make_test_hdf5(user_name='ubuntu'):
    with h5py.File('test.h5') as f:
        ...
        for path in path_list:
            ...
            if path[0:4] == i:
                if path[6] == c:
                    temp.append(np.array(Image.open('/home/' + user_name + '/Dataset/market/bounding_box_test/' + path)))
                else:
                    print len(temp)
...
def get_image_path_list(train_or_test = 'train',system_user_name = 'ubuntu'):
    if train_or_test == 'train':
        folder_path = '/home/' + system_user_name + '/Dataset/market/bounding_box_train'
    elif train_or_test == 'test':
        folder_path = '/home/' + system_user_name + '/Dataset/market/bounding_box_test'
    elif train_or_test == 'query':
        folder_path = '/home/' + system_user_name + '/Dataset/market/query'
